...
import * as adminScreenings from "@/app/api/admin/screenings/route";
import * as adminScreeningId from "@/app/api/admin/screenings/[id]/route";
...
reg("put", "/api/admin/users/:id", bind(adminUserId.PUT));
reg("delete", "/api/admin/users/:id", bind(adminUserId.DELETE));

reg("get", "/api/admin/screenings", bind(adminScreenings.GET));
reg("get", "/api/admin/screenings/:id", bind(adminScreeningId.GET));
reg("delete", "/api/admin/screenings/:id", bind(adminScreeningId.DELETE));
